...
knitr::opts_chunk$set(fig.width=6, fig.height=4, fig.path='Rmd_figs/',
...
the prothrombin data from the CSL-1 trial, comparing prednisone with
...
We are going to make two data sets out of that, `liver1` containing
the time-to-event data and `liver2` containing the longitudinal
prothrombin measurements.

```{r liver, warning=FALSE}
library(joineR)
data(liver)
...
xyplot(prothr ~ measyrs | treat, group = patid, data = liver2,
...
Rizopoulos has published a joint model analysis of the CSL trial data
(<http://www.drizopoulos.com/Rpgm/JM_sampe_analysis.R>), using the JM package.
We will simply follow this analysis with a very small adaptation, using
what we need only.
